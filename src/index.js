...
/*  
  22/12/2022
    Что нового?
      - Все используемые сетевых запросы работают при помощи библиотеки TanStack Query
    Исправления по замечаниям предыдущей проверки:
      - Добавлена обработка ошибок используемых сетевых запросов.
      - Иyпутам, принимающие на вход пароли, добавлено свойство type='password'
